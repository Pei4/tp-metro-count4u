      ...
      if (newCoordinates) {
        ...
        for (const scrollContainer of scrollableAncestors) {
          ...
          if (canScrollX && clampedCoordinates.x !== newCoordinates.x) {
            ...
            const canFullyScrollToNewCoordinates = direction === exports.KeyboardCode.Right && newScrollCoordinates <= maxScroll.x || direction === exports.KeyboardCode.Left && newScrollCoordinates >= minScroll.x;
            ...
            const canFullyScrollToNewCoordinates = direction === exports.KeyboardCode.Down && newScrollCoordinates <= maxScroll.y || direction === exports.KeyboardCode.Up && newScrollCoordinates >= minScroll.y;
